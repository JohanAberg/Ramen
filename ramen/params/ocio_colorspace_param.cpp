...
boost::python::object ocio_colorspace_param_t::to_python( const poly_regular_t& v) const
{
    return boost::python::object( v.cast<std::string>());
}

poly_regular_t ocio_colorspace_param_t::from_python( const boost::python::object& obj) const
{
    std::string str = boost::python::extract<std::string>( obj);
    return poly_regular_t( str);
}
