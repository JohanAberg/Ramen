...
boost::python::object string_param_t::to_python( const poly_regular_t& v) const
{
    return boost::python::object( v.cast<std::string>());
}

poly_regular_t string_param_t::from_python( const boost::python::object& obj) const
{
