...
void input_location_node_visitor::visit( nodes::node_t *n)
{
...
void output_location_node_visitor::visit( nodes::node_t *n)
{
...
void size_node_visitor::visit( nodes::node_t *n)
{
...
void draw_node_visitor::visit( nodes::node_t *n)
{
...
void draw_edges_visitor::visit( nodes::node_t *n)
{
...
void pick_node_visitor::visit( nodes::node_t *n)
{
...
void box_pick_node_visitor::visit( nodes::node_t *n)
{
...
void pick_edge_visitor::visit( nodes::node_t *n)
{
    Imath::V2f p0( generic_output_location( n));
    input_location_node_visitor visitor;
