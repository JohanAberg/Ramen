...
apply_corner_track_dialog_impl::apply_corner_track_dialog_impl() : QDialog( user_interface_t::Instance().main_window())
{
    setWindowTitle( "Apply Track");
	ui_.setupUi( this);
}

const image::tracker_node_t *apply_corner_track_dialog_impl::exec()
{
