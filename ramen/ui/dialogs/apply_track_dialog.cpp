...
apply_track_dialog_impl::apply_track_dialog_impl() : QDialog( user_interface_t::Instance().main_window())
{
    setWindowTitle( "Apply Track");
	ui_.setupUi( this);
}

const image::tracker_node_t *apply_track_dialog_impl::exec( image::apply_track_mode& mode, image::apply_track_use& use)
{
